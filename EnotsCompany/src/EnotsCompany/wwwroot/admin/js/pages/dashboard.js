...
$(document).ready(function() {
	...
	$('#spark-europe').sparkline([19,18,20,17,20,18,8,10,12,11,6,13,8,5,8,10,22,24,23,19,18,20,17], {
		type: 'bar',
		width: '100%',
		height: '20px',
		barColor: '#dfe2e7',
	...
	$('#spark-p2p').sparkline([19,18,20,17,10,8,7,12,11,6,19,18,20,17,20,18,22,24,23,19,18,20,17], {
		type: 'bar',
		width: '100%',
		height: '20px',
		barColor: '#dfe2e7',
